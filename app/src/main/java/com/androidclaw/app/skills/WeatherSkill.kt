...
class WeatherSkill : SkillDefinition {
    ...
    companion object {
        ...
        private val CITY_COORDS = mapOf(
            ...
            "guangzhou" to Pair(23.1, 113.3),
            "shenzhen" to Pair(22.5, 114.1),
            "chengdu" to Pair(30.6, 104.1),
            "hangzhou" to Pair(30.3, 120.2),
            "wuhan" to Pair(30.6, 114.3),
            "nanjing" to Pair(32.1, 118.8),
            "chongqing" to Pair(29.6, 106.6),
            "tianjin" to Pair(39.1, 117.2),
            "suzhou" to Pair(31.3, 120.6),
            "xian" to Pair(34.3, 108.9),
            "changsha" to Pair(28.2, 112.9),
            "qingdao" to Pair(36.1, 120.4),
            "dalian" to Pair(38.9, 121.6),
            "xiamen" to Pair(24.5, 118.1),
            "kunming" to Pair(25.0, 102.7),
            "harbin" to Pair(45.8, 126.6),
            "zhengzhou" to Pair(34.8, 113.7),
            "shenyang" to Pair(41.8, 123.4),
            "hongkong" to Pair(22.3, 114.2),
            "tokyo" to Pair(35.7, 139.7),
            "newyork" to Pair(40.7, -74.0),
            "london" to Pair(51.5, -0.1),
            "paris" to Pair(48.9, 2.3),
            "sydney" to Pair(-33.9, 151.2),
            "singapore" to Pair(1.3, 103.8),
            "seoul" to Pair(37.57, 127.0),
            "bangkok" to Pair(13.8, 100.5),
            "dubai" to Pair(25.2, 55.3),
            "losangeles" to Pair(34.0, -118.2),
            "sanfrancisco" to Pair(37.8, -122.4),
            "moscow" to Pair(55.8, 37.6),
            "berlin" to Pair(52.5, 13.4),
            "toronto" to Pair(43.7, -79.4),
            "vancouver" to Pair(49.3, -123.1),
            "taipei" to Pair(25.0, 121.5),
            "kaohsiung" to Pair(22.6, 120.3)
        )
    }
